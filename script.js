...
document.getElementById("loanForm").addEventListener("submit", function(event) {
    ...
    var creditDefaultDateInput = document.getElementById("creditDefaultDate").value.trim(); // Новое поле даты закрытия крупной просрочки
...
function calculateCreditHistoryRecovery() {
    ...
    if (loanDateInput === "" || creditDefaultDateInput === "") return;
    ...
    var monthsDifference = (loanDate.getMonth() - creditDefaultDate.getMonth()) +
        (12 * (loanDate.getFullYear() - creditDefaultDate.getFullYear()));
